...
import com.example.android.foodtinder.di.DaggerFavoriteRecipesComponent;
import com.example.android.foodtinder.di.DaggerFoodRecipeComponent;
import com.example.android.foodtinder.di.FavoriteRecipesComponent;
import com.example.android.foodtinder.di.FavoriteRecipesModule;
...
public class FoodTinderApplication extends Application {
    ...
    public FavoriteRecipesComponent getFavoriteRecipesComponent(){
        return DaggerFavoriteRecipesComponent.builder()
                .favoriteRecipesModule(new FavoriteRecipesModule())
                .contextModule(new ContextModule(this))
                .build();
    }
